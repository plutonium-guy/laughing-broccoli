...
# MAGIC PART A feature engineering is copied **verbatim** from V2 so the data
# MAGIC universe and parity flags are byte-identical; only PART B (the model)
# MAGIC changes.
# MAGIC
...
# ---- UNIVERSE PARITY with predict_all_clusters_v2.py (verbatim from V2) ----
COUNTRY_FROM = "bukrs"
OPEN_ITEMS_IGNORE_LOOKBACK = True
# NOTE: deliberately NO INCLUDE_ZERO_EXPOSURE — training keeps
# total_outstanding > 0 because the label is undefined at zero exposure.
...
# =========================================================
# PART A — V2-FIXED FEATURE ENGINEERING  (COPIED VERBATIM FROM V2)
# Identical universe + parity. Do not diverge from train_all_clusters_v2.py.
# =========================================================
